...
Call your `is_seq2()` function using arguments that will return FALSE and output a warning. Assign the function output to a variable called "is_seq2_FALSE_warning":
