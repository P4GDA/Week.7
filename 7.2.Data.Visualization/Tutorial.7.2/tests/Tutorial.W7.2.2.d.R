  ...
  cases = list(
    ottr::TestCase$new(
      ...
      code = {
        ...
        expect_equal("age", rlang::as_name(age_vs_mutational_burden_breast_cancer$mapping$x))
        expect_equal("mutational_burden", rlang::as_name(age_vs_mutational_burden_breast_cancer$mapping$y))
      }
    )
  )
)