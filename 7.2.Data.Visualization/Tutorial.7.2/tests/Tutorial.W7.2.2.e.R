  ...
  cases = list(
    ottr::TestCase$new(
      ...
      code = {
        ...
        expect_true(any(grepl("cancer_subtype", breast_cancer_subtype_mutational_burden$mapping$x)))
        expect_true(any(grepl("mutational_burden", breast_cancer_subtype_mutational_burden$mapping$y)))
