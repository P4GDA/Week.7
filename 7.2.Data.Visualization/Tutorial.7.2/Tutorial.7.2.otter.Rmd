...
In the tutorial we will be assigning plots to variables to allow auto-grading. To see the plot you created output the variable name, for example:
...
Create a bar plot to show the number of patients who are living and deceased. Assign the plot to a variable called "patient_survival_status_plot". 
```{r}
# Write and execute your code here
# YOUR CODE HERE
```
...
Notice that in general, younger patients have a lower mutational burden. This makes sense because there has been less time, and therefore fewer cell divisions, in their life in which mutations have had a chance to arise.
...
To make it easier to see the names of the breast cancer subtypes, which are very long and will overlap in the plot, add the following code to your plot 
...
Looking at this plot, invasive mixed mucinous carcinomas have the greatest median mutational burden. However, we cannot tell how many patients have each subtype of breast cancer, nor can we determine the significance of the difference. 
...
This plot shows us many things, we can see that the mutational burden tends to be higher for patients with adenocarcinomas, and that age and mutational burden correlate.
...
Fix all of these issues with functions and aesthetics we learned in lectures and call the new plot "tobacco_vs_mutations_survival_2".
```{r}
# Write and execute your code here
# YOUR CODE HERE
```
